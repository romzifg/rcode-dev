...
const LYNK_URL = "https://lynk.id/USERNAME/CASHFLOW";
...
const faqs = [
    {
        ...
        a: "Kamu akan mendapatkan template Cashflow berbasis Google Sheets beserta panduan instalasi untuk membantu proses penggunaan dan pengaturan awal.",
    },
    {
        q: "Apakah Cashflow membutuhkan aplikasi tambahan?",
        a: "Tidak. Cashflow menggunakan Google Sheets dan Google Apps Script sehingga dapat digunakan melalui akun Google yang kamu miliki.",
    },
    {
        q: "Apakah saya perlu bisa coding?",
        a: "Tidak perlu. Kamu cukup mengikuti panduan instalasi yang disediakan. Tidak diperlukan kemampuan pemrograman untuk menggunakan fitur Cashflow.",
    },
    {
        q: "Di mana data keuangan saya disimpan?",
        a: "Cashflow dirancang untuk bekerja pada Google Sheets yang berada di Google Drive akun kamu. Data transaksi disimpan pada spreadsheet tersebut sehingga kamu tetap dapat mengelola data melalui akun Google milikmu.",
    },
    {
        q: "Mengapa Google meminta izin akses?",
        a: "Cashflow menggunakan Google Apps Script untuk menjalankan fitur otomatisasi pada Google Sheets. Saat pertama kali menjalankan script, Google akan menampilkan izin yang diperlukan. Pastikan kamu membaca izin yang ditampilkan sebelum memberikan akses.",
    },
    {
        q: "Apakah Cashflow bisa digunakan dari HP?",
        a: "Ya. Karena Cashflow menggunakan Google Sheets, data dapat diakses melalui browser maupun aplikasi Google Sheets di perangkat yang mendukung.",
    },
    {
    ...
    },
    {
        ...
        a: "Ya. Panduan instalasi disediakan untuk membantu kamu mulai dari membuat salinan template hingga mengaktifkan fitur otomatisasi Cashflow.",
    },
];
                ...
                <section className="max-w-7xl mx-auto px-6 md:px-8 py-24 md:py-32">
                    <div className="max-w-3xl">
                        ...
                        <h1 className="font-serif text-[clamp(2.4rem,5vw,3.8rem)] leading-[1.1] tracking-tight mb-6">
                            Cashflow — <em className="not-italic text-rcode-amber">Catatan Keuangan</em>
                            <br />
                            yang Lebih Praktis
                        </h1>

                        <p className="text-white/60 text-[1.05rem] leading-[1.7] font-light max-w-2xl mb-10">
                            Template pencatatan keuangan berbasis Google Sheets dan Google Apps Script untuk membantu kamu mencatat pemasukan,
                            pengeluaran, dan memantau kondisi keuangan dengan lebih praktis.
                        </p>

                        <div className="flex flex-wrap gap-4 items-center">
                            <a
                                href="https://lynk.id/romzifg/2ql39x12mvo5"
                                target="_blank"
                ...
                <section className="border-y border-white/6 bg-rcode-bg2 py-16 md:py-20">
                    <div className="max-w-7xl mx-auto px-6 md:px-8">
                                ...
                                <div className="relative rounded-2xl border border-white/10 bg-rcode-bg3 overflow-hidden shadow-2xl">
                                    ...
                                    <div className="relative flex justify-center bg-black/20">
                                        <img
                                            ...
                                            alt={`Preview aplikasi Cashflow ${activePreview}`}
                                            className="w-md h-auto block"
                                        />
                                    </div>
                                </div>
                        ...
                        <div className="flex flex-wrap justify-center gap-3 mt-10">
                            {["Dashboard Keuangan", "Catatan Transaksi", "Riwayat Keuangan"].map((item) => (
                ...
                >
                    <div className="max-w-xl mx-auto px-6">
                        ...
                        <p className="text-white/55 text-[0.95rem] leading-[1.65] font-light mb-8">
                            Kelola pemasukan dan pengeluaran dengan lebih praktis menggunakan Google Sheets dan otomatisasi Apps Script.
                        </p>
